...
- navigation screen layout polish (2026-03-22): RouteMap fullBleed now uses absoluteFillObject so the map covers the entire screen; ManeuverCard overlays at the top; all four floating control rail buttons now share a consistent gray[800] dark circle at 44x44px
