...
export const es: TranslationKeys = {
  ...
  loop: {
    ...
    placementTooShort: '{{km}} km es la ruta más corta que te saca de la ciudad desde aquí. Las vueltas más cortas se quedan dentro.',
    ...
    startRide: 'Empezar ruta',
    badge: 'Circular',
    nameFallback: 'Ruta circular de {{km}} km',
    namePattern: '{{km}} km hacia {{direction}}',
    ...
    statTimeAtPace: 'Tiempo estimado a {{kmh}} km/h',
    roadsLabel: 'Carreteras',
    roadsBusy: '{{distance}} km por vías con tráfico',
