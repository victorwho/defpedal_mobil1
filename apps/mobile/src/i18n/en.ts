export const en = {
  ...
  onboarding: {
    ...
    a11yBack: 'Go back',
    continue: 'Continue',
    locationTitle: 'See how safe your streets are',
    locationSubtitle: 'We use your location to show a live safety score for your neighborhood and find the safest cycling routes nearby.',
    featureSafetyScore: 'Neighborhood safety score',
    featureSafetyScoreSub: 'See how your area ranks for cycling safety',
    featureRoutes: 'Safety-first routes',
    featureRoutesSub: 'Routes scored by real road risk data',
