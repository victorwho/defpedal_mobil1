export const en = {
  ...
  loop: {
    ...
    placementTooShort: '{{km}} km is the shortest ride that gets you out of town from here. Shorter loops stay inside it.',
    ...
    startRide: 'Start ride',
    badge: 'Loop',
    nameFallback: '{{km}} km loop',
    namePattern: '{{km}} km {{direction}}',
    ...
    statTimeAtPace: 'Est. time at {{kmh}} km/h',
    roadsLabel: 'Roads',
