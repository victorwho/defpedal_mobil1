...
export const ro: TranslationKeys = {
  ...
  loop: {
    ...
    placementTooShort: '{{km}} km e cea mai scurtă tură care te scoate din oraș de aici. Buclele mai scurte rămân în interior.',
    ...
    reach: 'Ajunge la {{km}} km distanță',
    ...
    startRide: 'Începe tura',
    badge: 'Tur',
    nameFallback: 'Tur de {{km}} km',
    namePattern: '{{km}} km spre {{direction}}',
    ...
    statTimeAtPace: 'Timp estimat la {{kmh}} km/h',
    roadsLabel: 'Drumuri',
  ...
  weatherWarning: {
    ...
    windBreezy: 'Briză: {{wind}} km/h — pedalează cu grijă',
    windBreezyGust: 'Briză: {{wind}} km/h, rafale până la {{gust}} km/h — pedalează cu grijă',
    windStrong: 'Vânt puternic: {{wind}} km/h — pedalează cu grijă',
    windStrongGust: 'Vânt puternic: {{wind}} km/h, rafale până la {{gust}} km/h — pedalează cu grijă',
    windHazardous: 'Vânt periculos: {{wind}} km/h — atenție extremă, preferă trasee adăpostite',
    windHazardousGust: 'Vânt periculos: {{wind}} km/h, rafale până la {{gust}} km/h — atenție extremă, preferă trasee adăpostite',
