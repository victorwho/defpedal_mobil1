...
export const ro: TranslationKeys = {
  ...
  onboarding: {
    ...
    a11yBack: 'Înapoi',
    continue: 'Continuă',
    locationTitle: 'Vezi cât de sigure sunt străzile tale',
    locationSubtitle: 'Folosim locația ta pentru a afișa un scor de siguranță live pentru cartierul tău și pentru a găsi cele mai sigure rute pentru biciclete din apropiere.',
    featureSafetyScore: 'Scorul de siguranță al cartierului',
    featureSafetyScoreSub: 'Vezi cum se clasează zona ta la siguranța cicliștilor',
    featureRoutes: 'Rute axate pe siguranță',
    featureRoutesSub: 'Rute evaluate după date reale de risc rutier',
