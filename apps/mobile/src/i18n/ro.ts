...
export const ro: TranslationKeys = {
  ...
  common: {
    ...
    error: 'Eroare',
    retry: 'Reîncearcă',
    routeDetailsSheet: 'Detalii traseu',
    guest: 'Vizitator',
    signedIn: 'Conectat',
    yes: 'Da',
    no: 'Nu',
  ...
  planning: {
    ...
    riskDataUnavailable:
      'Rutarea sigură alege aici străzi calme, prietenoase cu bicicliștii. Scorurile de risc stradă-cu-stradă nu sunt încă active în țara ta.',
  },
  ...
  preview: {
    ...
    saveRouteTitle: 'Salvează traseu',
    saveRouteA11y: 'Salvează acest traseu',
    saving: 'Se salvează...',
    dismissSaveRouteA11y: 'Închide dialogul de salvare',
    ...
    exportDestinationTitle: 'Exportă GPX',
    exportToGarmin: 'Trimite în Garmin Connect',
    exportShareFile: 'Salvează sau distribuie fișierul',
    ...
    peekSwipeUp: 'Trage în sus',
    lifeEarnedShort: 'de viață câștigată',
    missingConfigTitle: 'Configurație lipsă',
    missingConfigBody: 'Setează `EXPO_PUBLIC_MOBILE_API_URL` înainte de a cere previzualizări.',
    // Offline download card
    availableOffline: 'Disponibil offline',
    downloadingPct: 'Se descarcă... {{percent}}%',
  ...
  course: {
    ...
    saveCourse: 'Salvează traseul',
    saved: 'Traseu salvat pe acest telefon.',
    savedAlready: 'Salvat',
    errorSave: 'Nu am putut salva traseul pe telefon.',
    openFailed: 'Traseul nu a putut fi deschis. Poate a fost şters.',
    deleteCourse: 'Şterge traseul',
    emptyCourses: 'Niciun traseu importat deocamdată.',
  ...
  loop: {
    ...
    startLabel: 'Start',
    startCurrent: 'Locația curentă',
    startChange: 'Pornește din alt loc',
    startPickHint: 'Atinge harta ca să muți punctul de start.',
    startCustom: 'Punct ales',
    distanceLabel: 'Cât de lung',
    distanceValue: '{{distance}}',
    timeEstimate: 'aproximativ {{minutes}} min',
    timeEstimateFrom: 'aproximativ {{minutes}} min · pe baza a {{rides}} ture',
    terrainLabel: 'Teren',
    terrainFlat: 'Plat',
    terrainRolling: 'Ondulat',
    terrainHilly: 'Deluros',
    surfaceLabel: 'Suprafață',
    surfacePaved: 'Doar asfalt',
    surfaceAny: 'Permite offroad',
    surfaceOffroad: 'Preferă offroad',
    surfaceOffroadNote: 'Nu putem cere routerului să caute pietriș, așa că generăm tururi și îl alegem pe cel cu cel mai mult. Fiecare rezultat arată cât a găsit.',
    unpavedShare: '{{percent}}% neasfaltat',
    retraced: 'Se întoarce pe același drum pe {{percent}}% din traseu',
    placementLabel: 'Unde',
    placementOutOfTown: 'În afara orașului',
    placementAroundHere: 'Prin apropiere',
    placementTooShort: '{{distance}} e cea mai scurtă tură care te scoate din oraș de aici. Buclele mai scurte rămân în interior.',
    placementNoStepClears: 'Nici cea mai lungă tură pe care o oferim nu iese din oraș de aici. Pornește mai aproape de marginea orașului.',
    reach: 'Ajunge la {{distance}} distanță',
    headingLabel: 'Încotro',
    headingAny: 'Orice direcție',
    headingN: 'Nord',
    headingNE: 'Nord-est',
    headingE: 'Est',
    headingSE: 'Sud-est',
    ...
    headingW: 'Vest',
    headingNW: 'Nord-vest',
    headingDialA11y: 'Direcția turului, acum {{direction}}. Trage pentru a schimba.',

    findCta: 'Caută tururi',
    searching: 'Caut tururi…',
    searchProgress: '{{found}} din {{total}}',
    cancel: 'Anulează',
    tryAnother: 'Încearcă altele',

    resultsTitle: '{{count}} tururi',
    sessionCount: 'Găsite în această sesiune: {{count}}',
    climb: '{{distance}} urcare',
    ...
    saved: 'Tur salvat.',
    savedAlready: 'Salvat',
    errorSave: 'Turul nu a putut fi salvat.',
    startRide: 'Începe tura',
    badge: 'Tur',
    nameFallback: 'Tur de {{distance}}',
    namePattern: '{{distance}} spre {{direction}}',

    relaxedHeading: 'Merge spre {{actual}} — nimic {{terrain}} spre {{asked}}.',
    relaxedDistance: '{{distance}} — niciun tur de exact {{asked}}.',
    ...
    emptyTitle: 'Niciun tur de {{distance}} de aici',
    emptyBody: 'Străzile din zonă nu se închid într-un tur.',
    emptyTryLonger: 'Încearcă {{distance}}',
    ...
    statTimeAtPace: 'Timp estimat la {{speed}}',
    roadsLabel: 'Drumuri',
    roadsBusy: '{{distance}} pe drumuri aglomerate',
    roadsNoneBusy: 'Fără drumuri aglomerate',
    surfaceSplit: '{{paved}}% asfalt / {{unpaved}}% neasfaltat',
    spurNote: 'Include {{distance}} de ocol dus-întors',
    noPavedLoop: 'Nu există tur asfaltat aici — acesta are porțiuni neasfaltate',
    deleteLoop: 'Șterge turul',
    driftNotice: 'Turul s-a schimbat de când l-ai salvat — acum {{now}}, era {{before}}.',
  },
  risk: {
  ...
  nav: {
    ...
    inMeters: 'Peste {{distance}}, {{instruction}}',
    thenInMeters: ', apoi peste {{distance}}, {{instruction}}',
    ...
    resumeGuardTitle: 'Îți închei ultima cursă?',
    resumeGuardMessage: 'Pedalai spre {{destination}}. Reia navigarea sau salvează în istoric ce ai pedalat.',
    resumeGuardResume: 'Reia',
    resumeGuardSave: 'Salvează cursa',
    resumeGuardDiscard: 'Renunță la cursă',
    ...
    earlyEndFeltUnsafe: 'Traseul sugerat mi s-a părut nesigur',
    earlyEndNoLongerNeeded: 'Pur și simplu nu mai aveam nevoie de ghidare',
    earlyEndOther: 'Alt motiv',
    earlyEndOtherPlaceholder: 'Spune-ne de ce ai încheiat mai devreme…',
    earlyEndSave: 'Salvează cursa',
    earlyEndDiscard: 'Renunță la cursă',
    earlyEndSkip: 'Omite',
    recenter: 'Recentrează',
    offRoute: 'Ești în afara traseului',
    offCourse: 'Ai părăsit traseul — întoarce-te pe linie.',
    offCourseDistance: 'În afara traseului — {{distance}} până la linie.',
    ...
    direction: {
      ...
      right: 'la dreapta',
      straight: 'înainte',
      slightLeft: 'ușor la stânga',
      slightRight: 'ușor la dreapta',
      sharpLeft: 'brusc la stânga',
      sharpRight: 'brusc la dreapta',
    },
    maneuver: {
      theRoad: 'drum',
      depart: 'Pornește {{direction}} pe {{street}}',
      departNoDir: 'Pornește pe {{street}}',
      arrive: 'Ai ajuns la destinație',
      uturn: 'Întoarce-te complet pe {{street}}',
      turn: 'Virează {{direction}} pe {{street}}',
      continue: 'Continuă pe {{street}}',
      merge: 'Intră pe {{street}}',
      fork: 'Ține-o {{direction}} spre {{street}}',
      roundabout: 'Intră în sensul giratoriu spre {{street}}',
      rampOn: 'Intră pe rampă spre {{street}}',
      rampOff: 'Ieși spre {{street}}',
      generic: 'Continuă {{direction}} pe {{street}}',
    },
    maneuverShort: {
      continue: 'Continuă',
      depart: 'Pornește',
      ...
      roundaboutExit: 'Ieșirea {{exit}}',
      slightLeft: 'Ușor stânga',
      slightRight: 'Ușor dreapta',
      sharpLeft: 'Strâns stânga',
      sharpRight: 'Strâns dreapta',
      turnLeft: 'Virează stânga',
      turnRight: 'Virează dreapta',
      uturn: 'Întoarcere',
    },
    then: 'Apoi',
    etaNow: 'Acum',
    ...
    offlineFollowRoute: 'Fără conexiune — urmează ruta planificată',
    hazardGpsUnavailable: 'Nu pot raporta hazardul: GPS-ul nu este disponibil.',
    hazardRecordedSync: '{{label}} înregistrat, se va sincroniza automat.',
    hazardRecordedAnon: '{{label}} înregistrat. Se va sincroniza anonim când API-ul e disponibil.',
    freeMap: 'Hartă liberă',
    ...
    gpsSignal: 'Semnal GPS {{quality}}',
    gpsUnavailable: 'indisponibil',
    gpsStrong: 'puternic',
    gpsFair: 'acceptabil',
    gpsPoor: 'slab',
    steepLabel: 'Abrupt',
    steepUphill: 'în urcare',
    steepDownhill: 'în coborâre',
    steepGradeA11y: 'Pantă abruptă {{direction}}: {{percent}} la sută',
  },
  ...
  profile: {
    ...
    bodyWeightDesc: 'Folosită pentru calculul caloriilor arse',
    bodyWeightUnit: 'kg',
    ...
    showRouteFeatures: 'Arată elementele traseului',
    useMiles: 'Distanțe în mile',
    showMascot: 'Arată-l pe Pedal',
    themeDark: 'Întunecat',
    themeLight: 'Luminos',
    themeSystem: 'Sistem',
    quizRegion: 'Regiunea quiz-ului',
    quizRegionAuto: 'Automat',
    quizRegionRO: 'România',
    quizRegionES: 'Spania',
    quizRegionSubtitleAuto: 'Automat · detectat: {{country}}',
    ...
    dailyWeather: 'Meteo pentru ciclism',
    ...
    useMilesOn: 'Mile, picioare și mph',
    useMilesOff: 'Kilometri, metri și km/h',
    showRouteFeaturesOn: 'Tuneluri, poduri, semafoare și treceri feroviare apar pe hartă',
    ...
    dailyWeatherOn: 'Prognoză meteo pentru ciclism și mementouri, din când în când',
    dailyWeatherOff: 'Notificările meteo sunt dezactivate',
    ...
    badgesEarned: '{{earned}} / {{total}} insigne câștigate',
    confidentCyclistTitle: 'Ciclist încrezător',
    helpAFriend: 'Ajută un prieten să înceapă',
    helpAFriendSub: 'Distribuie Defensive Pedal unui prieten',
    referralShareMessage: 'Încearcă Defensive Pedal — trasee mai sigure pentru orice oraș. {{url}} #DefensivePedal',
  },
  ...
  communityScreen: {
    ...
    feedSub: 'Vezi turele partajate de comunitatea de cicliști — mai întâi cei din apropiere.',
  ...
  communityStats: {
    ...
    emptyBody:
      'Încă nu s-au partajat ture în apropiere — fii primul ciclist de pe această hartă. Feedul comunității de mai jos arată în continuare cicliști din zone mai îndepărtate.',
    totalRides: 'Total curse',
    distance: 'Distanță',
  ...
  cityHeartbeat: {
    ...
    allTime: 'TOTAL',
    allTimeNearby: 'TOTAL · LÂNGĂ TINE',
    topContributorsCommunity: 'TOP CONTRIBUITORI · TOATĂ COMUNITATEA',
    rides: 'Curse',
    ridesStarted: 'Curse',
    ...
    conditions_cold: 'Mai puțini azi — frig',
    conditions_hot: 'Mai puțini azi — caniculă',
    conditions_windy: 'Puțin mai puțini azi — vânt',
    conditions_ideal: 'Mai mulți azi — vreme bună de pedalat',
    cityEstimateTitle: 'CICLISM ÎN {{city}}',
    cyclistsDaily: 'Cicliști pe zi (est.)',
    cityEstimateSource: 'Estimare, nu o numărătoare: {{percent}}% din deplasări cu bicicleta (Banca Mondială, date {{year}}) la {{population}} locuitori.',
    cyclingEuropeTitle: 'CICLISM ÎN EUROPA',
    cyclingEuropeSub_one: 'Numărați de contoarele dintr-un oraș săptămâna aceasta — nu curse din aplicație',
    cyclingEuropeSub_other: 'Numărați de contoarele din {{cities}} orașe săptămâna aceasta — nu curse din aplicație',
    cyclistsCounted: 'Cicliști numărați',
    countersReporting: 'Contoare',
    networkTitle: 'REȚEAUA DE SIGURANȚĂ',
    networkSub: 'Pe ce circulă fiecare ciclist de aici',
    roadsScored: 'Drumuri evaluate',
    hazardsMapped: 'Pericole pe hartă',
    countriesCovered: 'Țări',
    daysRidden: 'Zile pedalate',
    distance: 'Distanță',
    co2Saved: 'CO2 economisit',
    donated: 'Donat',
    totalRides: 'Total curse',
    ...
    // ── Etichete oneste pentru fereastra/aria afișată ──
    cityFallback: 'orașul tău',
    pulse_today_nearby: 'Azi în {{city}}',
    pulse_week_nearby: 'Săptămâna aceasta în {{city}}',
    pulse_month_nearby: 'Luna aceasta în {{city}}',
    pulse_today_region: 'Azi în regiunea ta',
    pulse_week_region: 'Săptămâna aceasta în regiunea ta',
    pulse_month_region: 'Luna aceasta în regiunea ta',
    pulse_today_community: 'Azi în toată comunitatea Defensive Pedal',
    pulse_week_community: 'Săptămâna aceasta în toată comunitatea Defensive Pedal',
    pulse_month_community: 'Luna aceasta în toată comunitatea Defensive Pedal',
    scopeRegionTitle: 'Regiunea ta',
    scopeCommunityTitle: 'Comunitatea Defensive Pedal',
    activeRiders_today_one: 'ciclist activ azi',
    activeRiders_today_other: 'cicliști activi azi',
    activeRiders_week_one: 'ciclist activ săptămâna aceasta',
    activeRiders_week_other: 'cicliști activi săptămâna aceasta',
    activeRiders_month_one: 'ciclist activ luna aceasta',
  ...
  hazard: {
    ...
    describeTitle: 'Descrie pericolul',
    describeSubtitle: 'Opțional — o notă scurtă ajută ceilalți cicliști.',
    describePlaceholder: 'ex. câine liber, cioburi, poartă închisă…',
    describeA11y: 'Descriere pericol, opțional',
    describeA11yHint: 'Scrie o descriere scurtă sau lasă necompletat',
    reportShort: 'Raportează',
    backToTypes: 'Înapoi',
    backToTypesA11y: 'Înapoi la tipuri de pericole',
    dismissPickerA11y: 'Închide selectorul de pericole',
    cancelReportA11y: 'Anulează raportarea',
    reportItemA11y: 'Raportează {{label}}',
  ...
  weatherWarning: {
    ...
    subtitle: 'Fii atent și pedalează cu grijă.',
    startAnyway: 'Pornește oricum',
    rain: 'Probabilitate mare de ploaie mai târziu ({{percent}}%) — ia echipament și pedalează cu grijă',
    cold: 'Frig: {{temp}}°C — îmbracă-te gros și pedalează cu grijă',
    hot: 'Cald: {{temp}}°C — hidratează-te și pedalează cu grijă',
    warmingUp: 'Se încălzește mai târziu: {{min}}°C → {{max}}°C — pornește în straturi subțiri și ia apă',
    coolingDown: 'Se răcește mai târziu: {{max}}°C → {{min}}°C — ia un strat în plus și pedalează cu grijă',
    tempSwing: 'Variație mare de temperatură: {{min}}°C – {{max}}°C — îmbracă-te în straturi și pedalează cu grijă',
    windBreezy: 'Briză: {{wind}} — pedalează cu grijă',
    windBreezyGust: 'Briză: {{wind}}, rafale până la {{gust}} — pedalează cu grijă',
    windStrong: 'Vânt puternic: {{wind}} — pedalează cu grijă',
    windStrongGust: 'Vânt puternic: {{wind}}, rafale până la {{gust}} — pedalează cu grijă',
    windHazardous: 'Vânt periculos: {{wind}} — atenție extremă, preferă trasee adăpostite',
    windHazardousGust: 'Vânt periculos: {{wind}}, rafale până la {{gust}} — atenție extremă, preferă trasee adăpostite',
    airQualityPoor: 'Calitate slabă a aerului (AQI {{aqi}}) — limitează efortul și pedalează cu grijă',
    airQualityModerate: 'Calitate moderată a aerului (AQI {{aqi}}) — grupurile sensibile trebuie să pedaleze cu grijă',
    pm25: 'Particule fine ridicate: PM2.5 {{pm}} μg/m³ — pedalează cu grijă',
  },
  ...
  auth: {
    ...
    accountCreated: 'Verifică inbox-ul — ți-am trimis un link de confirmare. Deschide-l pe un telefon cu Defensive Pedal instalat.',
    resendConfirmation: 'Retrimite emailul de confirmare',
    confirmResent: 'Email de confirmare trimis — verifică-ți inbox-ul.',
  ...
  onboarding: {
    ...
    // Pasul tip bicicleta (dupa inregistrare).
    bikeTypeTitle: 'Ce pedalezi?',
    bikeTypeSubtitle: 'Potrivim traseele cu bicicleta ta.',
    bikeTypeContinue: 'Continuă',
    bikeRoadDesc: 'Anvelope subțiri, ideală pe asfalt neted',
    bikeCityDesc: 'Naveta zilnică și drumuri scurte',
    bikeMountainDesc: 'Făcută pentru poteci, pietriș și teren accidentat',
    bikeEbikeDesc: 'Cu asistență la pedalare sau electrică',
    bikeRecumbentDesc: 'Poziție lăsată pe spate, aproape de sol',
    bikeOtherDesc: 'Altceva — pliabilă, cargo, triciclă',
    bikeConsequenceNone: 'Alege una și potrivim preferința de suprafață. O poți schimba oricând în Profil.',
    bikeConsequencePaved: 'Vom activa „Evită drumurile neasfaltate”, ca traseele să rămână pe asfalt. O poți schimba oricând în Profil.',
    bikeConsequenceUnpaved: 'Vom dezactiva „Evită drumurile neasfaltate”, ca potecile și pietrișul să rămână disponibile. O poți schimba oricând în Profil.',
    bikeConsequenceNeutral: 'Lăsăm setarea „Evită drumurile neasfaltate” așa cum este. O poți schimba oricând în Profil.',
    ...
    skipShort: 'Omite',
    a11ySkip: 'Omite configurarea',
    a11yBack: 'Înapoi',
    continue: 'Continuă',
    locationTitle: 'Rute care evită drumurile periculoase',
    locationSubtitle: 'Folosim locația ta pentru a găsi cele mai sigure rute pentru biciclete, evaluate cu date reale de risc rutier.',
    ...
    usernameCommunitySub: 'Așa te vor vedea ceilalți cicliști în comunitate.',
    ...
    signupSubMandatory:
      'Alertele de pericol funcționează doar pentru că fiecare raport vine de la un ciclist real. Contul tău gratuit păstrează aceste date de încredere — și îți salvează turele, seriile și insignele pe orice telefon.',
    ...
    regionContinueAnywayHint:
      'Poți planifica în continuare rute standard de ciclism, dar rutarea sigură nu este încă disponibilă în țara ta, iar datele comunității despre pericole sunt limitate.',
  ...
  impact: {
    ...
    thisRideImpact: 'Impactul cursei',
    badgesEarnedTitle: 'Insigne câștigate',
    viewAllAchievements: 'Vezi toate realizările >',
    xpEarnedTitle: 'XP câștigat',
    xpTotal: 'Total',
    legendMaxRank: 'Legendă — Rang maxim',
    dayStreakShort: 'zile streak',
  ...
  quiz: {
    title: 'Quiz zilnic',
    loadFailed: 'Quiz-ul nu s-a putut încărca',
    retry: 'Reîncearcă',
    correct: 'Corect!',
    notQuite: 'Nu chiar',
    done: 'Gata',
    streakMaintained: 'Streak menținut! Continuă tot așa.',
  },
  ...
  achievements: {
    ...
    emptyCategory: 'Nicio insignă în această categorie încă. Continuă să pedalezi!',
    timeJustNow: 'chiar acum',
    timeMinsAgo: 'acum {{count}}m',
    timeHoursAgo: 'acum {{count}}h',
    timeDaysAgo: 'acum {{count}}z',
    tabAll: 'Toate',
    tabFirsts: 'Premiere',
    tabRiding: 'Cursă',
    ...
    tabExplore: 'Explorare',
    tabEvents: 'Evenimente',
    secretName: '???',
    secretFlavor: 'Această insignă e un mister. Continuă să pedalezi ca s-o descoperi!',
    rarityLine: 'Doar {{percent}}% dintre cicliști au această insignă',
    earnedDate: 'Câștigată {{date}}',
    share: 'Distribuie',
    progressA11y: '{{current}} din {{target}} {{unit}}, {{percent}}% finalizat',
  },
  ...
  leaderboard: {
    ...
    scope_region: 'Încă nimeni în apropiere — clasament pe {{distance}}',
  ...
  mapA11y: {
    ...
    hazardUpcoming: 'Pericol în față: {{type}}, la {{distance}}.',
  ...
  myShares: {
    title: 'Rutele tale partajate',
    loadError: 'Nu am putut încărca partajările. Trage pentru a reîmprospăta.',
    emptyTitle: 'Nicio partajare încă',
    emptySubtitle: 'Partajează o rută și va apărea aici, împreună cu numărul de vizualizări și înscrieri.',
    emptyCta: 'Planifică o rută',
    revokedPill: 'Revocată',
    opens: 'deschideri',
    signups: 'înscrieri',
    copyLink: 'Copiază linkul',
    copyLinkA11y: 'Copiază linkul de partajare',
    shareAgain: 'Partajează din nou',
    revoke: 'Revocă',
    revokeA11y: 'Revocă partajarea',
    revokedOn: 'Revocată {{date}}',
    noExpiry: 'Fără expirare',
    expiresToday: 'Expiră azi',
    expiresTomorrow: 'Expiră mâine',
    expiresInDays: 'Expiră în {{days}} zile',
    linkCopiedTitle: 'Link copiat',
    linkCopiedBody: 'Partajează-l oriunde.',
    copyFailedTitle: 'Copiere eșuată',
    copyFailedBody: 'Nu am putut copia linkul. Încearcă din nou.',
    revokeConfirmTitle: 'Revoci această partajare?',
    revokeConfirmBody: 'Cei care deschid linkul vor vedea o pagină „indisponibilă".',
    revokeFailedTitle: 'Revocare eșuată',
    revokeAuthRequired: 'Conectează-te și încearcă din nou.',
    revokeNetworkError: 'Verifică conexiunea și încearcă din nou.',
  },
  premium: {
    name: 'Pedal Plus',
    badge: 'PLUS',
    sheetTitle: 'Pedal Plus',
    sheetSubtitle: 'Tine aplicatia in viata si pedaleaza cu mai mult.',
    benefitRoutesTitle: 'Rute salvate nelimitate',
    benefitRoutesBody: 'Pastreaza fiecare naveta, tura si drum. Gratuit pastrezi {{count}}.',
    benefitPacksTitle: 'Harti offline care raman',
    ...
    perMonth: '{{price}} / luna',
    perYear: '{{price}} / an',
    trialNote: '{{days}} zile gratuit, apoi {{price}}.',
    cta: 'Incepe perioada gratuita',
    ctaNoTrial: 'Aboneaza-te',
    restore: 'Restaureaza achizitia',
    manage: 'Gestioneaza abonamentul',
    legal: 'Se reinnoieste automat pana la anulare. Poti anula oricand din magazin.',
    activeTitle: 'Pedal Plus este activ',
    trialActive: 'Perioada gratuita - se reinnoieste pe {{date}}',
    renews: 'Se reinnoieste pe {{date}}',
    endsOn: 'Se incheie pe {{date}}',
    billingRetry: 'Este o problema cu plata ta. Actualizeaz-o ca sa pastrezi Plus.',
    offlineNotice: 'Iti aratam ultimul status confirmat.',
    profileRowFree: 'Ia Pedal Plus',
    profileRowActive: 'Pedal Plus',
    limitRoutesTitle: 'Ai atins limita de rute salvate',
    limitRoutesBody: 'Gratuit pastrezi {{count}} rute salvate. Sterge una ca sa faci loc sau treci pe Plus pentru nelimitat.',
    limitCoursesTitle: 'Ai atins limita de trasee',
    limitCoursesBody: 'Gratuit poţi păstra {{count}} trasee importate pe telefon. Cu Pedal Plus sunt nelimitate.',
    limitPacksTitle: 'Ai atins limita de harti offline',
    limitPacksBody: 'Gratuit include {{count}} zona offline. Cu Plus pastrezi mai multe si nu mai expira.',
    limitFlatTitle: 'Ai epuizat rutele plate',
    limitFlatBody: 'Ai folosit cele {{count}} rute plate din luna asta. Iti calculam o ruta Safe, sau treci pe Plus pentru nelimitat.',
    limitHistoryTitle: 'Turele mai vechi sunt ascunse',
    limitHistoryBody: 'Gratuit vezi ultimele {{days}} zile. Turele mai vechi sunt in siguranta - Plus ti le aduce inapoi.',
