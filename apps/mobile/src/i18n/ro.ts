...
export const ro: TranslationKeys = {
  ...
  onboarding: {
    ...
    a11yBack: 'Înapoi',
    continue: 'Continuă',
    locationTitle: 'Rute de 2,1× mai sigure decât Google Maps',
    ...
    featureStatSub: 'În medie, pe rutele de ciclism — nu doar cel mai rapid traseu',
    featureRoutes: 'Rute axate pe siguranță',
    featureRoutesSub: 'Fiecare rută evaluată după date reale de risc rutier',
    ...
    goalExploreSub: 'Descoperă trasee sigure pentru biciclete în orașul tău',
    goalBeginnerSub: 'Obișnuiește-te cu rute pentru începători, cu risc scăzut',
    analyzing: 'Analizăm cartierul tău...',
    yourNeighborhood: 'Cartierul tău',
    statSafe: 'sigure',
    statAverage: 'medii',
    statRisky: 'riscante',
    statVeryRisky: 'f.riscante',
    firstRouteEyebrow: 'Prima ta rută',
    firstRouteTitleNamed: 'Rută sigură către {{name}} și înapoi',
    ...
    statDuration: 'Durată',
    statSafety: 'Siguranță',
    impactCo2: 'CO2 economisit',
    impactMoney: 'Bani economisiți',
    impactRiskySegments: 'Segmente riscante',
