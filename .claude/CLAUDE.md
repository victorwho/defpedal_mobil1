...
> most recent bullets, not the top. Latest shipped work: **risk scores EU-wide
> in-app + RO-era remnant cleanup + cool/shade routing** (commit `e0784c6`,
> preview v0.2.124 build 127 device-tested). Server halves of that batch are
> **not yet deployed to Cloud Run** — deploy from a clean `main` worktree.
