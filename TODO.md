...
- [ ] **GCP monitoring / alerting not configured** — No alerts for Cloud Run errors, latency spikes, OSRM downtime, or DB issues. P3-4 / `docs/archive/securityfix.md`. Blocks observability for production traffic.
